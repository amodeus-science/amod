...
public enum ICRApoolingDispatcherUtils {
    ...
    public static Pair<List<double[][]>, HashMap<VirtualNode<Link>, List<Link>>> getFlowsOut(Network network, VirtualNetwork<Link> virtualNetwork,
            int PlanningHorizon, int timeStep, Config config, double round_now, HashMap<VirtualNode<Link>, List<Link>> linkMap) {
