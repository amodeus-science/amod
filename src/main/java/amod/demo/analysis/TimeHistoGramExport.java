...
public class TimeHistoGramExport implements AnalysisExport {
    public final static String FILENAME = "totalDriveTimePerRoboTaxi";
    private final TimeElement timeElement;
    private static final Scalar S2M = RationalScalar.of(1, 60);

    public TimeHistoGramExport(TimeElement timeElement) {
