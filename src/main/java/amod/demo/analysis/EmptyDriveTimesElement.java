...
public class EmptyDriveTimesElement implements AnalysisElement {
	...
	public void register(SimulationObject simulationObject) {
		...
		simulationObject.vehicles.stream().forEach(vc -> //
		{
			...
			if (!vc.roboTaxiStatus.equals(RoboTaxiStatus.STAY) && !vc.roboTaxiStatus.equals(RoboTaxiStatus.WAITING)
					&& !vc.roboTaxiStatus.equals(RoboTaxiStatus.DRIVEWITHCUSTOMER) //
					&& (prevStatus.get(vehicle).equals(RoboTaxiStatus.STAY)
	...
	/**
	 * @return {@link Tensor} containing the requests served for each
	 *         {@link RoboTaxi}
	 */
