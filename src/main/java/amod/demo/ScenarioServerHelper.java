...
public enum ScenarioServerHelper {
     ...
     * @return */
    public static Controler setUpStandardControler(SimulationProperties simulationProperties) {
        ...
        controler.addOverridingModule(new AmodeusVirtualNetworkModule(simulationProperties.getScenarioOptions()));
