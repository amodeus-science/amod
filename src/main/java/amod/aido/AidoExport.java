...
public class AidoExport implements AnalysisExport {
    ...
    private double[] scaleRatios = new double[] { 1.0, 1.0, 1.0 };

    /** aido score element */
    private final AidoScoreElement aidoScoreElem;

    /* package */ public AidoExport(AidoScoreElement aidoScoreElem) {
    ...
    public void summaryTarget(AnalysisSummary analysisSummary, File relativeDirectory, ColorScheme colorScheme) {
        ...
        try {
            TimeChart.of( //
                    ...
                    FILTERSIZE, //
                    new double[] { 1.0 }, //
                    new String[] { "total waited time [s]" }, //
                    "time of day", //
                    "waiting time", //
                    time, //
                    waiting,//
                    aidoScoreElem.getCurrentScore().Get(0).number().doubleValue(), //
        ...
        try {
            TimeChart.of( //
                    ...
                    FILTERSIZE, //
                    new double[] { 1.0, 1.0 }, //
                    new String[] { "total distance with customer [m]", "total empty distance [m]" }, //
                    "time of day", //
                    "distance", //
                    time, //
                    distances, //
